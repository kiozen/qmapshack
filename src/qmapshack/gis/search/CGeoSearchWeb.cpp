...
QList<CGeoSearchWeb::service_t> CGeoSearchWeb::defaultServices() {
  QList<service_t> tmp;
  tmp << service_t("PeakFinder", "https://www.peakfinder.org/?lat=%2&lng=%1&ele=%3&azi=0&zoom=5",
                   "://icons/32x32/SearchWebPeakfinder.png");
  tmp << service_t("Waymarked Trails Hiking", "https://hiking.waymarkedtrails.org/#routelist?map=13!%2!%1",
                   "://icons/32x32/SearchWebWaymarked.png");
  tmp << service_t("Wikiloc", "https://www.wikiloc.com/wikiloc/map.do?lt=%2&ln=%1&z=13",
                   "://icons/32x32/SearchWebOutings.png");
  tmp << service_t("Wikiloc Skitours", "https://www.wikiloc.com/wikiloc/map.do?lt=%2&ln=%1&z=13&act=40,17",
                   "://icons/32x32/SearchWebOutings.png");
  tmp << service_t("Webcam", "https://webcams.travel/map/#lat=%2&lng=%1&z=12", "://icons/32x32/SearchWebCam.png");
  tmp << service_t("Meteoblue 7 days", "https://www.meteoblue.com/en/weather/forecast/week/%2N%1E",
                   "://icons/32x32/SearchWebMeteo.png");
  tmp << service_t("Meteoblue 5 days", "https://www.meteoblue.com/en/weather/forecast/meteogramfive/%2N%1E",
                   "://icons/32x32/SearchWebMeteo.png");
  tmp << service_t("Meteoblue Multi. Mod.", "https://www.meteoblue.com/en/weather/forecast/multimodel/%2N%1E",
                   "://icons/32x32/SearchWebMeteo.png");
  tmp << service_t("Meteoblue Maps", "https://www.meteoblue.com/en/weather/webmap/index/%2N%1E?level=surface&zoom=8",
                   "://icons/32x32/SearchWebMeteo.png");
  tmp << service_t("Ventusky Map", "https://www.ventusky.com/?p=%2;%1;8&l=rain-3h",
                   "://icons/32x32/SearchWebMeteo.png");
...
QMenu* CGeoSearchWeb::getMenu(const QPointF& pt, QWidget* parent, bool execute) const {
  ...
  for (const service_t& service : services) {
    ...
    // By index; the name is user data.
