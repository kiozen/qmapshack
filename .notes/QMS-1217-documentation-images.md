...
| 6 | **shots.py** (#1250) | `compose`, `take`, `replay`, `unused`; the pinned command line and environment; one process per scenario | `shots.py replay` replays every committed shot |
